...
public class NotificationManager {
    ...
    public func filterNotifications(of pet: Pet) -> [UNNotificationRequest] {
    ...
    public func getNotifications() async {
        notifications = await UNUserNotificationCenter.current().pendingNotificationRequests()
    }

    public func changeNotificationTime(of petName: String, with date: Date, for type: NotificationType) {
    ...
    public func checkAllAppNotifications() async {
        notifications = await notificationCenter.pendingNotificationRequests()
    }

    public func createNotifications(for pet: Pet, morningTime: Date?, eveningTime: Date?) async {
